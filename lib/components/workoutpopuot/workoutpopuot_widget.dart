    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [const Color(0xFFFF0000), FlutterFlowTheme.of(context).primaryText],
          stops: const [0.4, 1.0],
                ...
                child: Row(
                  ...
                  children: [
                    ClipRRect(
                      borderRadius: BorderRadius.circular(8.0),
                      child: Image.network(
                        'https://images.unsplash.com/photo-1434682772747-f16d3ea162c3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw4fHxneW0lMjBsZWd8ZW58MHx8fHwxNjk5ODc0MDAwfDA&ixlib=rb-4.0.3&q=80&w=1080',
                        width: 52.0,
                        height: 200.0,
                        fit: BoxFit.cover,
                      ),
                ...
                child: Row(
                  ...
                  children: [
                    ClipRRect(
                      borderRadius: BorderRadius.circular(8.0),
                      child: Image.network(
                        'https://images.unsplash.com/photo-1475274110913-480c45d0e873?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxjYWxmJTIwZXhlcmNpc2V8ZW58MHx8fHwxNjk5NjEyOTA1fDA&ixlib=rb-4.0.3&q=80&w=1080',
                        width: 52.0,
                        height: 200.0,
                        fit: BoxFit.cover,
                      ),
                  ...
                  child: Row(
                    ...
                    children: [
                      ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.network(
                          'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwzfHxkZWFkbGlmdHxlbnwwfHx8fDE2OTk2MTI4Mjd8MA&ixlib=rb-4.0.3&q=80&w=1080',
                          width: 52.0,
                          height: 200.0,
                          fit: BoxFit.cover,
                        ),
