                            ...
                            StreamBuilder<List<ExercisesRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ExercisesRecord>
                                    columnExercisesRecordList = snapshot.data!;
                                return Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: List.generate(
                                    ...
                                    final columnExercisesRecord =
                                        columnExercisesRecordList[columnIndex];
                                    return Builder(
                                      builder: (context) {
                                        final currentset =
                                            columnExercisesRecord.sets.toList();
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: WeightinputWidget(
                                                      key: Key(
                                                          'Keysei_${currentsetIndex}_of_${currentset.length}'),
                                                      parameter1:
                                                  ...
                                                  Expanded(
                                                    child: RepinputWidget(
                                                      key: Key(
                                                          'Keyyc3_${currentsetIndex}_of_${currentset.length}'),
                                                      parameter1:
                                                          currentsetItem.reps,
                                                    ),
                                                  ),
