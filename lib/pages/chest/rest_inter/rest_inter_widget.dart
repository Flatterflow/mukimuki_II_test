...
import 'rest_inter_model.dart';
export 'rest_inter_model.dart';

class RestInterWidget extends StatefulWidget {
  const RestInterWidget({super.key});

  @override
  State<RestInterWidget> createState() => _RestInterWidgetState();
}

class _RestInterWidgetState extends State<RestInterWidget> {
  late RestInterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RestInterModel());
