...
import 'flys_model.dart';
export 'flys_model.dart';

class FlysWidget extends StatefulWidget {
  const FlysWidget({super.key});

  @override
  State<FlysWidget> createState() => _FlysWidgetState();
}

class _FlysWidgetState extends State<FlysWidget> {
  late FlysModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FlysModel());
