...
import 'otherchest_copy_model.dart';
export 'otherchest_copy_model.dart';

class OtherchestCopyWidget extends StatefulWidget {
  const OtherchestCopyWidget({super.key});

  @override
  State<OtherchestCopyWidget> createState() => _OtherchestCopyWidgetState();
}

class _OtherchestCopyWidgetState extends State<OtherchestCopyWidget> {
  late OtherchestCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OtherchestCopyModel());
