...
class SquatWidget extends StatefulWidget {
  const SquatWidget({super.key});

  @override
  State<SquatWidget> createState() => _SquatWidgetState();
}
            ...
            child: Column(
              ...
              children: [
                const FlutterFlowYoutubePlayer(
                  url: 'https://youtu.be/mEmynZt2SwY?si=DhAftoHNXEdbN7Pb',
                  autoPlay: false,
                  looping: true,
                  mute: false,
                  showControls: true,
