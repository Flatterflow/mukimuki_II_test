...
import 'editprof_model.dart';
export 'editprof_model.dart';
                          ...
                          child: Padding(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => TextFormField(
                                ...
                                onFieldSubmitted: (_) async {
                                  if (_model
                                      .emailTextController2.text.isEmpty) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(
                                        content: Text(
                                          'Email required!',
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      ...
                      Align(
                        alignment: const AlignmentDirectional(0.19, 0.88),
                        child: Icon(
                          Icons.edit,
              ...
              FFButtonWidget(
                onPressed: () async {
                  await currentUserReference!.update(createUsersRecordData(
                    ...
                    photo: valueOrDefault(currentUserDocument?.photo, ''),
