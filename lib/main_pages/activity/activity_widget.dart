                ...
                Column(
                  ...
                  children: [
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        ...
                                        return Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              listViewWorkoutsRecord.sets.length
                                                  .toString(),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium,
                              ...
                              children: [
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 10.0),
                                  child: Text(
                                    'Completed workout will appear here',
                                    style:
                                        FlutterFlowTheme.of(context).bodyMedium,
                                  ),
                                ),
                    ...
                    Align(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          context.pushNamed('Schedulevideo');
                        },
                        text: 'Video Explaining How to Create a Schedule',
                        options: FFButtonOptions(
                          height: 40.0,
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              24.0, 0.0, 24.0, 0.0),
