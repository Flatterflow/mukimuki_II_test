...
import 'schema/homepage_grid_templates_record.dart';
...
export 'schema/homepage_grid_templates_record.dart';
...
/// Functions to query HomepageGridTemplatesRecords (as a Stream and as a Future).
Future<int> queryHomepageGridTemplatesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      HomepageGridTemplatesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<HomepageGridTemplatesRecord>> queryHomepageGridTemplatesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      HomepageGridTemplatesRecord.collection,
      HomepageGridTemplatesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<HomepageGridTemplatesRecord>> queryHomepageGridTemplatesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
